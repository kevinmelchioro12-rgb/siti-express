...
Legge prospects.csv + template/site-template.html e genera un sito trilingue
...
LABELS = {  # per <title> e meta (in italiano, lingua di default)
 "restaurant":"Ristorante","cafe":"Caffè & Pasticceria","beauty":"Studio di Bellezza",
 "auto":"Officina","generic":"Attività locale",
}
SYN = {
 ...
 "beauty":["beauty","bellezza","estetica","parrucchiere","hair","salon","friseur","kosmetik","nails","spa","barber","barbiere"],
 "auto":["auto","car","garage","officina","werkstatt","mechanic","meccanico","kfz","autofficina"],
}
